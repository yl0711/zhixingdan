...
var upimgAction, addAction , modifyAction , modifyStatusAction ,seachByStatusAction , seachByNameAction, 
	modifyBtn, closeBtn, openBtn, recommend_input;
...
function AddFirmMode()
{
	...
	if(!AddFirmModeHtml)
	{
		...
		var upimgfile =  '<div  style = "width:150px ;position:relative;"> ';
			...
			upimgfile += ' <input type="file" data-url = "" id="imgfile"   class="imgfile"    name="uploadFile" style="opacity: 0; position: absolute; width: 100%;height:100%;top:0;left:0;" />';
