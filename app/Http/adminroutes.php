...
Route::group(['namespace'=>'Admin'], function() {
    ...
    Route::group(['middleware'=>['adminauth', 'adminAccessLog']], function() {
        ...
        Route::group(['prefix' => 'user'], function() {
            ...
            Route::match(['get', 'post'], 'transfer/{id}', ['uses'=>'AdminUserController@transferUser'])->where('id', '[0-9]+');
        ...
        Route::group(['prefix'=>'documents'], function() {
            ...
            Route::match(['get', 'post'], 'copy/{id}', ['uses'=>'DocumentsController@copy'])->where('id', '[0-9]+');
